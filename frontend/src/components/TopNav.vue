...
const searchIndex = [
  ...
  { id: 'font-stack', title: 'Font Stack', description: 'Font fallback stacks and combinations', category: 'Tools', path: '/tools/font-stack', icon: 'layers', tags: ['font', 'stack', 'typography', 'tool'] },
  { id: 'font-subsetting', title: 'Font Subsetting', description: 'Optimize fonts by subsetting character sets', category: 'Tools', path: '/tools/font-subsetting', icon: 'content_cut', tags: ['font', 'optimization', 'typography', 'tool'] },
  ...
  { id: 'migration-assistant', title: 'Deprecation & Migration Assistant', description: 'Track deprecated components and migrate components and tokens from old to new versions', category: 'Tools', path: '/tools/migration', icon: 'refresh', tags: ['migration', 'versioning', 'upgrade', 'tokens', 'components', 'deprecation', 'management'] },
  { id: 'code-quality', title: 'Code Quality Checks', description: 'Lint, format, and enforce best practices', category: 'Admin', path: '/admin/code-quality', icon: 'check_circle', tags: ['quality', 'linting', 'formatting'] },
  { id: 'vulnerability-scanner', title: 'Vulnerability Scanner', description: 'Scan dependencies for security vulnerabilities', category: 'Admin', path: '/admin/security', icon: 'security', tags: ['security', 'vulnerabilities', 'dependencies'] },
  ...
  { id: 'session-replay', title: 'Session Replay', description: 'See exactly what users experience with session replay and heatmaps for your applications', category: 'HCD', path: '/tools/session-replay', icon: 'videocam', tags: ['session-replay', 'openreplay', 'heatmaps', 'user-analytics', 'monitoring'] },
