...
const searchIndex = [
  ...
  { id: 'deprecation-manager', title: 'Deprecation Manager', description: 'Track and manage deprecated components', category: 'Components', path: '/components/deprecation', icon: 'archive', tags: ['deprecation', 'management', 'tracking'] },
  { id: 'migration-assistant', title: 'Migration Assistant', description: 'Migrate components from old to new versions', category: 'Components', path: '/components/migration', icon: 'refresh', tags: ['migration', 'versioning', 'upgrade'] },
