...
const searchIndex = [
  ...
  { id: 'map-generator', title: 'Map Generator', description: 'Create interactive maps with markers, regions, and tooltips. Generate React or Vue components with Leaflet integration', category: 'Tools', path: '/tools/map-generator', icon: 'map', tags: ['map', 'leaflet', 'markers', 'regions', 'interactive', 'visualization', 'tool'] },
