...
const searchIndex = [
  ...
  { id: 'user-persona-generator', title: 'User Persona Generator', description: 'Create detailed user personas from research data to inform design decisions', category: 'Research Repo', path: '/research/user-personas', icon: 'person', tags: ['persona', 'user-research', 'research', 'user-profile', 'archetype'] },
