...
const searchIndex = [
  ...
  { id: 'code-quality', title: 'Code Quality Checks', description: 'Lint, format, and enforce best practices', category: 'Tools', path: '/code-quality', icon: 'check_circle', tags: ['quality', 'linting', 'formatting'] },
  { id: 'vulnerability-scanner', title: 'Vulnerability Scanner', description: 'Scan dependencies for security vulnerabilities', category: 'Tools', path: '/security', icon: 'security', tags: ['security', 'vulnerabilities', 'dependencies'] },
