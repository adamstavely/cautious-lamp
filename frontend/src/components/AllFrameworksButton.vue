<template>
  ...
  >
    <button
      ...
      :class="[
        'px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm text-left flex items-center justify-between',
...
const selectedLabel = computed(() => {
  ...
  return option ? option.label : 'All Frameworks';
});
