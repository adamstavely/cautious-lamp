...
export enum Role {
  ...
  DESIGN_SYSTEM_ADMIN = 'design_system_admin',
...
export class RbacService {
  ...
  private getRoleDescription(role: Role): string {
    const descriptions: Record<Role, string> = {
      ...
      [Role.DESIGN_SYSTEM_ADMIN]: 'Complete administrative access to all design system features.',
      [Role.REVIEW_ADMIN]: 'Manage review workflows, approvals, and review administration.',
